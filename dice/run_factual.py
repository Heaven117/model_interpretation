...
d = dice_ml.Data(dataframe=dataset, continuous_features=['age', 'educational-num','hours-per-week'], outcome_name='income')
...
save_json(dices,args.out_dir+f'dice_{args.model_type}_epoch{args.epoch}_{len(dice_exp.cf_examples_list)}.json')
